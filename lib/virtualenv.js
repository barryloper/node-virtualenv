...
VirtualEnv.prototype._find = function(callback) {
  ...
  pypi.getPackageReleases("virtualenv", function(versions) {
    ...
    pypi.getReleaseUrls("virtualenv", latestValidVersion, function(urls) {
...
VirtualEnv.prototype._pip = function _pip(callback) {
  ...
  var pipProc = childProcess.spawn(path.join("bin", "pip"),
